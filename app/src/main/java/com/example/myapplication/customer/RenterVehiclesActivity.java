...
public class RenterVehiclesActivity extends AppCompatActivity {
    ...
    private com.google.android.material.button.MaterialButton btnViewReviews;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnViewReviews.setOnClickListener(v -> {
            Intent intent = new Intent(this, RenterReviewsActivity.class);
            ...
            if (value != null) {
                for (DocumentSnapshot doc : value.getDocuments()) {
                    ...
                    vehicleItems.add(new VehicleItem(
                            ...
                            asDouble(doc.get("driverFeePerDay")),
                            firstImage(doc),
                            isBooked,
    ...
    private void openBooking(VehicleItem item) {
        ...
        intent.putExtra("driverFeePerDay", item.driverFeePerDay);
    ...
    private static class VehicleAdapter extends RecyclerView.Adapter<VehicleAdapter.VehicleViewHolder> {
        ...
        public void onBindViewHolder(@NonNull VehicleViewHolder holder, int position) {
            ...
            holder.tvDriverFee.setText(String.format(
                    java.util.Locale.getDefault(),
                    "Driver fee per day: %.2f",
                    item.driverFeePerDay
            ));
            holder.tvStatus.setText(item.bookingStatus);
